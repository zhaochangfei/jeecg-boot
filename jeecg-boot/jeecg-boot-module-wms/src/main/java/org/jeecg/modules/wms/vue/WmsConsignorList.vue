<template>
  <a-card :bordered="false">
    ...
    <wms-consignor-modal ref="modalForm" @ok="modalFormOk"></wms-consignor-modal>
  </a-card>
</template>
...
<script>
  ...
  import WmsConsignorModal from './modules/WmsConsignorModal'

  export default {
    name: 'WmsConsignorList',
    ...
    data () {
      return {
        ...
        url: {
          ...
          delete: "/wms/wmsConsignor/delete",
          deleteBatch: "/wms/wmsConsignor/deleteBatch",
          exportXlsUrl: "/wms/wmsConsignor/exportXls",
          importExcelUrl: "wms/wmsConsignor/importExcel",
