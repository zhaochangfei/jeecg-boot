                ...
                <a-row :gutter="24">
                  <a-col :span="5">
                    <a-form-item label="收货人名称">
                      <j-input placeholder="请输入收货人名称" v-model="queryParam.name"></j-input>
                    </a-form-item>
                  </a-col>
                  <a-col :span="5">
                    <a-form-item label="收货人电话">
                      <j-input placeholder="请输入收货人电话" v-model="queryParam.iphone"></j-input>
                    </a-form-item>
                  </a-col>
  ...
  methods: {
    ...
    handleOk() {
      if (this.selectionRows.length > 0) {
        ...
        this.$emit('wmsConsigneeUp', this.selectionRows)
        this.visible = false
      } else {
