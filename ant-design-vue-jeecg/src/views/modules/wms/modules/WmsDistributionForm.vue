  ...
  <a-spin :spinning="confirmLoading">
    <j-form-container :disabled="formDisabled">
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        ...
        <a-row>
          <a-col :span="8">
            <a-form-model-item label="发货人" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="consignorId_dictText">
        ...
        <a-row>
          <a-col :span="8">
            <a-form-model-item label="收货人" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="consigneeId_dictText">
               <a-input-group compact>
        ...
        <a-row>
          <a-col :span="8">
            <a-form-model-item label="总运费（费用合计）" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="sumMoney">
        ...
        <a-row>
          ...
          <a-col :span="8">
            <a-form-model-item label="是否中转 0否 1是" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="transferIs">
        ...
        <div class="fx_list">
              ...
              <a-row :gutter="10">
                <a-col :span="24">
                  ...
                  >
                    <span slot="inputa" slot-scope="text, record, index">
                      <a-input-number :min="0" :precision="4" v-model="details[index].transactionNumber" />
                    </span>

                    <span slot="inputb" slot-scope="text, record, index">
                      <a-input-number :min="0" :precision="0" v-model="details[index].number" />
                    </span>
                    <span slot="inputc" slot-scope="text, record, index">
                      <!-- <a-input-number disabled :min="0" :precision="2" v-model="details[index].totalMoney" /> -->
                      {{
                        (details[index].totalMoney = details[index].transactionNumber * details[index].number)
                          | keepTwoNum
                      }}
                    </span>
                    <span slot="inputd" slot-scope="text, record, index">
                      <a-input-number :min="0" :precision="2" v-model="details[index].otherExpenses" />
                    </span>
                    <span slot="inputf" slot-scope="text, record, index">
                      <a-select v-model="details[index].tax" style="width: 100%">
                        <a-select-option value="0">是</a-select-option>
                        <a-select-option value="1">否</a-select-option>
                      </a-select>
                    </span>

                    <span slot="inpute" slot-scope="text, record, index">
                      <j-date
                        :getCalendarContainer="getModalAsContainer"
                        placeholder=""
                        v-model="details[index].submissionTime"
                      ></j-date>
                    </span>

                    <span slot="remark" slot-scope="text, record, index">
                      <a-input placeholder="" v-model="details[index].remark"></a-input>
                    </span>
                  </a-table>
                </a-col>
              </a-row>
