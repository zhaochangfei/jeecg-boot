    ...
    <div>
      ...
      >
        ...
        <span slot="action" slot-scope="text, record">
          <a v-show="record.sstatus == 0" @click="handleStatus(record)">受理</a>
          ...
          <a v-show="record.sstatus == 1" @click="handleDetail(record)">详情</a>
...
export default {
  ...
  data() {
    return {
      ...
      url: {
        ...
        changeStatusUrl: '/wms/wmsInformation/changeStatusById',
      },
      dictOptions: {},
      superFieldList: [],
    }
  ...
  methods: {
    ...
    handleStatus(record) {
      this.loading = true
      const that = this
      getAction(this.url.changeStatusUrl, { id: record.id })
        .then((res) => {
          if (res.success) {
